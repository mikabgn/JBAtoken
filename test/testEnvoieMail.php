...
if ($mail->addReplyTo('test@labruleriecomtoise.fr', 'admin')) {
    ...
    $mail->isHTML(false);
    $mail->Body = "Coucou c'est le president Emmanuel Macron, Je vous recrute en tant que premier ministre a prendre ou a apprendre ou a laisser ou a se lasser Cordialement Moi-meme:)";
